...
public class AnalyticTable extends PGSQLTable implements IAnalyticTable {
    ...
    public AnalyticTable(Result result, Database database ) {
        ...
        columns.put("starttimestamp", new ColumnFeatures("starttimestamp", PGSQLDatabase.DATE_TYPE, -1, false));
        columns.put("endtimestamp", new ColumnFeatures("endtimestamp", PGSQLDatabase.DATE_TYPE, -1, false));
